        ...
        <div id='contact' className={`contact-container ${isActiveSection ? 'contact-in' : 'contact-container'}`}>
            ...
            <h2 className='title'>Contact me</h2>
                <div className='contact-text'>
                    ...
                    <a href='https://www.linkedin.com/in/maria-jose-guerrero-padilla/' style={{color: 'blueviolet', margin: 10, padding: 10}} target="_blank">
                    ...
                    <form className='form' action="">
                        ...
                        <textarea className='box' name='message'  placeholder='message' rows={4} cols={25} />
                    </form>
                    <p style={{ margin: 10}}>
                        
                        Estaré encantada de responder y contarte cómo puedo contribuir a tu proyecto.
                    </p>
