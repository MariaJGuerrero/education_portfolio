        ...
        <div id="proyects" className={`proyectsPage-container ${isActiveSection ? 'proyects-in' : 'proyectsPage-container'}`}>
            <main>
                ...
                <section className='cards-section'>
                    <button className='cards-buttons' onClick={()=> {}}>
                    ...
                    {proyects.map((proyect)=> 
                        <div className={'card border-light bg-light mb-3 proyect-card'} style={{minWidth: '35rem'}}>
                     ...
                     <button style={{ marginLeft: '95vw' }} className='cards-buttons'>
